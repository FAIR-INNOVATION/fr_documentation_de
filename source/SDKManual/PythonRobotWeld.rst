...
.. csv-table:: 
    ...
    "Beschreibung", "Ruft den Schweißgeräte-Steuermodus ab"
    "Erforderliche Parameter", "
    - ``mode``: Schweißgeräte-Steuermodus; 0-Gleichstrom-Einknopf-Modus; 1-Impuls-Einknopf-Modus; 2-JOB-Modus; 3-Nahsteuerungsmodus; 4-getrennter Modus; 5-CC/CV-Modus; 6-TIG; 7-CMT
    "
    "Standardparameter", "Keine"
    "Rückgabewert", "Fehlercode, 0-Erfolg; ungleich Null-Fehler" 

Codebeispiel zum Abrufen des Schweißgeräte-Steuermodus
++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
.. versionadded:: python SDK-v3.9.8
...
.. csv-table:: 
    ...
    "Beschreibung", "Ruft die erweiterte DI-Funktionskonfiguration ab"
    "Erforderliche Parameter", "
    - ``DIConfig``: Erweiterte DI-Eingangskonfiguration; DIConfig[0]-erweiterter DI-Port Schweißgerät bereit
...
.. csv-table:: 
    ...
    "Beschreibung", "Ruft die erweiterte DO-Funktionskonfiguration ab"
    "Erforderliche Parameter", "
    - ``DOConfig``: Erweiterte DO-Ausgangskonfiguration; DOConfig[0]-erweiterter DO-Port Schweißgerät Lichtbogenstart
...
Codebeispiel für erweiterte DI/DO abrufen
++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
.. versionadded:: python SDK-V3.9.8
...
.. csv-table:: 
    ...
    "Beschreibung", "Legt fest, ob nach Pendelende zum Zyklus-Nullpunkt zurückgekehrt wird"
    "Erforderliche Parameter", "
    - ``flag``: Ob nach Pendelende zum Zyklus-Nullpunkt zurückgekehrt wird; 0-nicht zurückkehren; 1-zum Zyklus-Nullpunkt zurückkehren
    "
    "Standardparameter", "Keine"
    "Rückgabewert", "Fehlercode, 0-Erfolg; ungleich Null-Fehler"    
...
.. csv-table:: 
    ...
    "Beschreibung", "Ruft die Parameter für die Rückkehr zum Zyklus-Nullpunkt nach Pendelende ab"
    "Erforderliche Parameter", "
    - ``flag``: Ob nach Pendelende zum Zyklus-Nullpunkt zurückgekehrt wird; 0-nicht zurückkehren; 1-zum Zyklus-Nullpunkt zurückkehren
    "
    "Standardparameter", "Keine"
