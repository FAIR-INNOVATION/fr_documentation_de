...
.. code-block:: c++
    ...
    /**
    * @brief Konfiguration der Laserschweißgerät-Parameter
...
.. code-block:: c++
    ...
    /**
    * @brief Laserschweißen Start/Stopp einstellen
    * @param[in] io_type Kommunikationstyp 0-IO 1-UDP
    * @param[in] status Steuerwort 0-Laser aus 1-Laser an
    * @param[in] max_waittime Maximale Wartezeit, Einheit Millisekunden, Standard 10000
    * @return Fehlercode
    */
...
.. code-block:: c++
    ...
    /**
    * @brief Laserschweißgerät-Fehler zurücksetzen
    * @param[in] io_type Kommunikationstyp 0-IO 1-UDP
...
.. code-block:: c++
    ...
    /**
    * @brief Laserschweißgerät-Betriebsstatus abrufen
    * @param[in] io_type Kommunikationstyp 0-IO 1-UDP
...
.. code-block:: c++
    ...
    /**
    * @brief Laserschweißgerät-Fehlerstatus abrufen
    * @param[in] io_type Kommunikationstyp 0-IO 1-UDP
...
.. code-block:: c++
    ...
    /**
    * @brief Konfigurierte Parameter des Laserschweißgeräts abrufen
    * @param[in] num Gruppennummer, die eingestellt werden soll (1~10)
...
.. code-block:: c++
    ...
    * @param[out] dutyCycle Tastverhältnis
    * @param[out] freq Frequenz
    * @return Fehlercode, 0 zeigt Erfolg an, nicht 0 zeigt Fehler an
    */
...
.. code-block:: c++
    ...
    /**
    * @brief Erweiterte IO-Aktivierungs-DO-Port des Laserschweißgeräts konfigurieren
...
.. code-block:: c++
    ...
    /**
    * @brief Erweiterte IO-Start-DO-Port des Laserschweißgeräts konfigurieren
...
.. code-block:: c++
    ...
    /**
    * @brief Erweiterte IO-Fehlerrücksetzungs-DO-Port des Laserschweißgeräts konfigurieren
...
.. code-block:: c++
    ...
    /**
    * @brief Erweiterte DI für Betriebsstatus (Laser an-Status) des Laserschweißgeräts konfigurieren
...
Erweiterte DI für Fehlerstatus des Laserschweißgeräts konfigurieren
+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
...
.. code-block:: c++
    ...
    /**
    * @brief Erweiterte DI für Fehlerstatus des Laserschweißgeräts konfigurieren
...
.. code-block:: c++
    ...
    /**
    * @brief Stellt den Echtzeit-Pendeloffset ein
    * @param [in] offset Echtzeit-Offset [mm, °]
    * @return Fehlercode
    */
    errno_t SetWeaveOffsetRT(DescPose offset);

Codebeispiel für Echtzeit-Pendelgeschwindigkeit und -Offset
+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
...
.. code-block:: c++
    ...
    if (rtn != 0)
    {
        ...
        std::cout << "============================================================" << std::endl;
    std::cout << " Test der Pendelgeschwindigkeit und des Echtzeit-Offsets" << std::endl;
    std::cout << "============================================================" << std::endl;
    ExaxisPos epos(0, 0, 0, 0);
    DescPose offset_pos(0, 0, 0, 0, 0, 0);
    ...
    // ---- Step 2: MoveJ zum Pendel-Eingangspunkt ----
    ...
    std::this_thread::sleep_for(std::chrono::milliseconds(500));
    // ---- Step 3: WeaveStart, starte Pendel-MoveL-Thread ----
    ...
    weaveThread.detach(); // Hintergrundausführung
    std::this_thread::sleep_for(std::chrono::milliseconds(500)); // Auf Bewegungsbeginn warten
    // ---- Step 4: Geschwindigkeitstest (Haupt-Thread, Pendel-MoveL im Hintergrund) ----
    ...
    std::this_thread::sleep_for(std::chrono::milliseconds(5000));
    // ---- Step 5: SetWeaveOffsetRT-Offsettest (Haupt-Thread, Pendel-MoveL im Hintergrund) ----
    ...
    // ---- Step 6: Auf Pendel-MoveL warten, dann WeaveEnd ----
    std::cout << "\nStep 6: Wait for weave MoveL, then WeaveEnd" << std::endl;
    // Da detach verwendet wurde, warte bis weaveRunning false wird
    ...
    robot.WeaveEnd(0);
    std::this_thread::sleep_for(std::chrono::milliseconds(500));
    // ---- Step 7: MoveL zurück zum Startpunkt ----
    ...
    std::cout << "============================================================" << std::endl;
    std::cout << " Test der Pendelgeschwindigkeit und des Echtzeit-Offsets abgeschlossen" << std::endl;
    std::cout << "============================================================" << std::endl;
    }    