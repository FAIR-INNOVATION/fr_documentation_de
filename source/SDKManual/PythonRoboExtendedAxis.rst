...
.. csv-table::
    ...
    "Beschreibung", "Array-Sauggreifer steuern"
    "Erforderliche Parameter", "- ``slaveID``: Slave-Nummer (0 für Broadcast)
    - ``len``: Anzahl der zu steuernden Sauger
    - ``ctrlValue``: Steuerwerte (Liste/Bytes): 1 = mit maximalem Vakuum ansaugen, 2 = mit eingestelltem Vakuum ansaugen, 3 = Ansaugen stoppen"
    "Standardparameter", "Keine"
    "Rückgabewert", "Fehlercode: 0 = Erfolg, sonst Fehlercode"
...
.. csv-table::
    ...
    "Beschreibung", "Status des Array-Sauggreifers abrufen"
    "Erforderliche Parameter", "- ``slaveID``: Slave-Nummer"
    "Standardparameter", "Keine"
    "Rückgabewert", "- Fehlercode: 0 = Erfolg, sonst Fehlercode
    - ``state``: Saugzustand: 0 = Objekt losgelassen, 1 = Werkstück erfolgreich angesaugt, 2 = kein Objekt angesaugt, 3 = Objekt abgelöst
    - ``pressValue``: Aktuelles Vakuum (kPa)
    - ``error``: Aktueller Fehlercode des Saugers"
...
.. csv-table::
    ...
    "Beschreibung", "Auf Saugerstatus warten"
    "Erforderliche Parameter", "- ``slaveID``: Slave-Nummer
    - ``state``: Erwarteter Saugzustand (siehe GetSuckerState)
    - ``ms``: Maximale Wartezeit (ms)"
    "Standardparameter", "Keine"
    "Rückgabewert", "Fehlercode: 0 = Erfolg, Fehlercode bei Timeout/Fehler"
...
.. code-block:: python
    ...
    # Verbindung zur Robotersteuerung herstellen
    robot = Robot.RPC('192.168.58.2')
    robot.OpenLuaUpload("C://Project/PeripherieSDK/CtrlDev_sucker.lua")
    time.sleep(2)
...
.. csv-table::
    ...
    "Erforderliche Parameter", "- ``filePath``: Lokaler Pfad zur Open-Protocol-Lua-Datei"
    "Standardparameter", "Keine"
    "Rückgabewert", "Fehlercode: 0 = Erfolg, sonst Fehlercode"
...
.. csv-table::
    ...
    "Beschreibung", "Slave-Kartenparameter (Feldbus) abrufen"
    "Erforderliche Parameter", "Keine"
    "Standardparameter", "Keine"
    "Rückgabewert", "- Fehlercode: 0 = Erfolg, sonst Fehlercode
    - ``type``: Protokolltyp: 0 = Ethercat, 1 = CClink, 3 = Ethercat (Dopplung?), 4 = EIP
    - ``version``: Protokollversion
    - ``connState``: Verbindungsstatus: 0 = nicht verbunden, 1 = verbunden"
...
.. csv-table::
    ...
    "Beschreibung", "In Slave-DO (Digitalausgang) schreiben (Feldbus)"
    "Erforderliche Parameter", "- ``DOIndex``: DO-Nummer (Startadresse)
    - ``writeNum``: Anzahl der zu schreibenden Werte
    - ``status``: Liste der zu schreibenden Werte (0/1), max. 8"
    "Standardparameter", "Keine"
    "Rückgabewert", "Fehlercode: 0 = Erfolg, sonst Fehlercode"
...
.. csv-table::
    ...
    "Beschreibung", "In Slave-AO (Analogausgang) schreiben (Feldbus)"
    "Erforderliche Parameter", "- ``AOIndex``: AO-Nummer (Startadresse)
    - ``writeNum``: Anzahl der zu schreibenden Werte
    - ``status``: Liste der zu schreibenden Werte (int), max. 8"
    "Standardparameter", "Keine"
    "Rückgabewert", "Fehlercode: 0 = Erfolg, sonst Fehlercode"
...
.. csv-table::
    ...
    "Beschreibung", "Slave-DI (Digitaleingang) lesen (Feldbus)"
    "Erforderliche Parameter", "- ``DIIndex``: DI-Nummer (Startadresse)
    - ``readNum``: Anzahl der zu lesenden Werte"
    "Standardparameter", "Keine"
    "Rückgabewert", "- Fehlercode: 0 = Erfolg, sonst Fehlercode
    - ``status[8]``: Liste der gelesenen Werte (0/1), max. 8"
...
.. csv-table::
    ...
    "Beschreibung", "Slave-AI (Analogeingang) lesen (Feldbus)"
    "Erforderliche Parameter", "- ``AIIndex``: AI-Nummer (Startadresse)
    - ``readNum``: Anzahl der zu lesenden Werte"
    "Standardparameter", "Keine"
    "Rückgabewert", "- Fehlercode: 0 = Erfolg, sonst Fehlercode
    - ``status[8]``: Liste der gelesenen Werte (int), max. 8"
...
.. csv-table::
    ...
    "Beschreibung", "Auf erweiterten DI-Eingang warten (Feldbus)"
    "Erforderliche Parameter", "- ``DIIndex``: DI-Nummer
    - ``status``: Erwarteter Zustand: 0 = niedrig, 1 = hoch
    - ``waitMs``: Maximale Wartezeit (ms)"
    "Standardparameter", "Keine"
    "Rückgabewert", "Fehlercode: 0 = Erfolg, Fehlercode bei Timeout"
...
.. csv-table::
    ...
    "Beschreibung", "Auf erweiterten AI-Eingang warten (Feldbus)"
    "Erforderliche Parameter", "- ``AIIndex``: AI-Nummer
    - ``waitType``: Bedingung: 0 = größer als, 1 = kleiner als
    - ``value``: Vergleichswert
    - ``waitMs``: Maximale Wartezeit (ms)"
    "Standardparameter", "Keine"
    "Rückgabewert", "Fehlercode: 0 = Erfolg, Fehlercode bei Timeout"
