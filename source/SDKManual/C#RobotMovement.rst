...
.. code-block:: c#
    ...
    private void btnJOG_Click(object sender, EventArgs e)
    {
        ...
        robot.SetSpeed(35);
        robot.StartJOG(0, 1, 0, 15, 20.0f, 30.0f);   // Einzelgelenkbewegung, StartJOG ist nicht blockierend. Während der Bewegung empfangene Bewegungsbefehle (inkl. StartJOG) werden verworfen.
        Thread.Sleep(1000);
        robot.StopJOG(1);  // Verzögertes Stoppen der Einzelachsen-JOG-Bewegung
        //robot.ImmStopJOG();  // Sofortiges Stoppen der Einzelachsen-JOG-Bewegung
        ...
        robot.StartJOG(2, 1, 0, 15, 20.0f, 30.0f);   // JOG im Basiskoordinatensystem
        Thread.Sleep(1000);
        robot.StopJOG(3);  // Verzögertes Stoppen
        //robot.ImmStopJOG();
        ...
        robot.StartJOG(4, 1, 0, 15, 20.0f, 30.0f);   // JOG im Werkzeugkoordinatensystem
        Thread.Sleep(1000);
        robot.StopJOG(5);
        //robot.ImmStopJOG();
        ...
        robot.StartJOG(8, 1, 0, 15, 20.0f, 30.0f);   // JOG im Werkstückkoordinatensystem
        Thread.Sleep(1000);
        robot.StopJOG(9);
        //robot.ImmStopJOG();
...
Codebeispiel für Vollkreisbewegung im kartesischen Raum
+++++++++++++++++++++++++++++++++++++++++++++++++++++++
.. versionadded:: C#SDK-V1.1.4 Web-3.8.3
