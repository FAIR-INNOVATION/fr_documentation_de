...
.. code-block:: Java
    ...
    * @param flag Ob nach Pendelende zum Zyklus-Nullpunkt zurückgekehrt wird; 0-nicht zurückkehren; 1-zum Zyklus-Nullpunkt zurückkehren
    * @return Fehlercode
    */
...
.. code-block:: Java
    ...
    /**
    * @brief Stellt die Geschwindigkeit ein (Befehlsframe, niedrige Latenz)
    * @param vel Geschwindigkeitsprozent, Bereich [0~100]
    * @return Fehlercode
    */
