...
.. code-block:: c++
    ...
    * @param  [in] etcp  Pose des Werkzeugmittelpunkts relativ zum Flanschmittelpunkt der Endseite
    * @param  [in] etool  Pose des am Roboterende montierten Werkstückkoordinatensystems
    * @return  Fehlercode
    */
    errno_t  SetExToolCoord(int id, DescPose *etcp, DescPose *etool);

Externe Werkzeugkoordinatensystemliste einstellen
+++++++++++++++++++++++++++++++++++++++++++++++++++++++++
.. versionchanged:: C++SDK-v3.9.8
...
.. code-block:: c++
    ...
    /**
    * @brief  Stellt die externe Werkzeugkoordinatensystemliste ein
    * @param  [in] id Koordinatensystemnummer, 20-39 entsprechen den externen Werkzeugkoordinatensystemen 0-19
    * @param  [in] etcp  Pose des Werkzeugmittelpunkts relativ zum Flanschmittelpunkt der Endseite
    * @param  [in] etool  Pose des am Roboterende montierten Werkstückkoordinatensystems
    * @return  Fehlercode
...
Codebeispiel für die Operationen mit dem externen Werkzeugkoordinatensystem des Roboters
++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
.. versionchanged:: C++SDK-v3.9.8
