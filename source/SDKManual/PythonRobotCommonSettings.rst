...
.. csv-table::
    ...
    "Erforderliche Parameter", "- ``luaPath``: Pfad zum automatischen Kalibrierungs-Lua-Programm: QX-Roboter - '/fruser/FR_CalibrateTheToolTcp.lua'; LA-Roboter - '/usr/local/etc/controller/lua/FR_CalibrateTheToolTcp.lua'
